...
env_kwargs = {
    ...
    "evader_speed": 0.05,  # food speed
    "poison_speed": 0.05,  # poison speed
    ...
    "encounter_reward": 1.5,  # reward for a pursuer colliding with a food object org: 0.01
    "thrust_penalty": -0.01,#-0.5,  # scaling factor for the negative reward used to penalize large actions
