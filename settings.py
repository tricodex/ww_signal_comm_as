...
env_kwargs = {
    ...
    "n_evaders": 8,  # number of food objects
    ...
    "n_sensors": 8,  # number of sensors on all pursuing archea (agents), 30 max
    "sensor_range": 0.15,  # length of sensor dendrite on all pursuing archea (agents)
    "radius": 0.015,  # archea base radius. Pursuer: radius, food: 2 x radius, poison: 3/4 x radius
    "obstacle_radius": 0.005,  # radius of obstacle object
    ...
    "pursuer_max_accel": 0.075,  # pursuer archea maximum acceleration (maximum action size) org: 0.01
    "evader_speed": 0.01,  # food speed, org: 0.01
    "poison_speed": 0.08,  # poison speed, org: 0.01
    "poison_reward": -1.0,  # reward for pursuer consuming a poison object (typically negative)
    "food_reward": 20.0,  # reward for pursuers consuming a food object
    "encounter_reward": 0.01,  # reward for a pursuer colliding with a food object org: 0.01
    "thrust_penalty": 0, #-0.01, #-0.5,  # scaling factor for the negative reward used to penalize large actions
