...
env_kwargs = {
    ...
    "n_sensors": 30,  # number of sensors on all pursuing archea (agents), 30 max
    ...
    "poison_speed": 0.025,  # poison speed, org: 0.01
    ...
    "thrust_penalty": -0.001, #-0.01, #-0.5,  # scaling factor for the negative reward used to penalize large actions
